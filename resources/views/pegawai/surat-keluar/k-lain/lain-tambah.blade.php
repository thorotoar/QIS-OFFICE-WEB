                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="basic-elements">
                                <form id="form-addSuratKeluar" action="{{route('surl-tambah-selesai', ['id' => $jenis->id])}}" enctype="multipart/form-data" method="post">
                                    {{csrf_field()}}
                                    <div class="row">
                                        <div class="col-md-3">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control input-sm" type="Text" name="lampiran" required>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label>Tempat</label>
                                                <input class="form-control input-sm" type="Text" name="tempat">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">

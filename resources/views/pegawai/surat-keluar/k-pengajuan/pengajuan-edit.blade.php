                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="basic-elements">
                                <form id="form-addSuratKeluar" action="{{route('surpenga-update', $sKeluar->id)}}" enctype="multipart/form-data" method="post">
                                    {{csrf_field()}}
                                    <div class="row">
                                        <div class="col-md-3">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input class="form-control input-sm" type="text" value="{{$value['nama_barang']}}" name="nama_barang[]" >
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-2">
                                                            <div class="form-group">
                                                                <label>Jumlah Barang <span class="text-danger">*</span></label>
                                                                <input class="form-control input-sm" type="Text" value="{{$value['jumlah_barang']}}" name="jumlah_barang[]" onkeypress="return numberOnly(event, false)">
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-3">
                                                            <div class="form-group">
                                                                <label>Harga Barang <span class="text-danger">*</span></label>
                                                                <input class="form-control input-sm" type="Text" value="{{$value['harga_barang']}}" name="harga_barang[]" onkeypress="return numberOnly(event, false)">
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-1">
                                                            <div class="form-group">
    ...
    <script>
        ...
        $('#addrow').click(function(){
            $('.item-tambah:last').after('<div class="form-group item-tambah">\n' +
                ...
                '                                                <div class="col-sm-6">\n' +
                '                                                    <div class="form-group">\n' +
                '                                                        <input class="form-control input-sm" type="text" name="nama_barangs[]" >\n' +
                '                                                    </div>\n' +
                '                                                </div>\n' +
                '                                                <div class="col-sm-2">\n' +
                '                                                    <div class="form-group">\n' +
                '                                                        <input class="form-control input-sm" type="Text" name="jumlah_barangs[]" onkeypress="return numberOnly(event, false)">\n' +
                '                                                    </div>\n' +
                '                                                </div>\n' +
                '                                                <div class="col-sm-3">\n' +
                '                                                    <div class="form-group">\n' +
                '                                                        <input class="form-control input-sm" type="Text" name="harga_barangs[]" onkeypress="return numberOnly(event, false)">\n' +
                '                                                    </div>\n' +
                '                                                </div>\n' +
                '                                                <div class="col-sm-1">\n' +
                '                                                    <div class="form-group">\n' +

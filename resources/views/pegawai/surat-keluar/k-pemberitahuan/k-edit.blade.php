...
@section('title', 'QIS OFFICE | EDIT SURAT PEMBERITAHUAN')
    ...
    <div class="page-wrapper">
        ...
        <div class="row page-titles">
            ...
            <div class="col-md-7 align-self-center">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="javascript:void(0)">Edit Surat Pemberitahuan</a></li>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control input-sm" type="text" name="jumlah_program" placeholder="Contoh: 1" value="{{$iKeluar->jumlah_program}}" onkeypress="return numberOnly(event, false)" required>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <hr>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-5">
                                                            <div class="form-group">
                                                                ...
                                                                <input class="form-control input-sm" type="Text" value="{{$value['lama_program']}}" name="lama_program[]" placeholder="Contoh: 2 bulan 24 kali" required>
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control form-control-sm custom-select" name="jenis_program[]" required>
                                                                    ...
                                                                    @if($value['jenis_program'] == 'Program 1')
                                                                        <option value="Program 1" selected>Program 1</option>
                                                                        <option value="Program 2">Program 2</option>
                                                                    @elseif($value['jenis_program'] == 'Program 2')
                                                        ...
                                                        <div class="col-sm-1">
                                                            <div class="form-group">
                                                                <label for="">-</label><br>
                                                                <a class="btn btn-primary btn-flat btn-sm" href="{{route('h-konten', $value['id'])}}" title="Hapus">
                                                                    <i class="fa fa-remove"></i>
                                                                </a>
                                                                {{--<a class="btn btn-primary btn-flat btn-sm delText" href="javascript:;" title="Hapus">--}}
                                                                    {{--<i class="fa fa-remove"></i>--}}
                                                                {{--</a>--}}
                                                            </div>
                                                        </div>
    ...
    <script type="text/javascript">
        ...
        $('#addrow').click(function(){
            $('.item-tambah:last').after('<div class="form-group item-tambah">\n' +
                ...
                '                                                    <div class="col-sm-5">\n' +
                '                                                        <div class="form-group">\n' +
                '                                                            <input class="form-control input-sm" type="Text" name="lama_programs[]" placeholder="Contoh: 2 bulan 24 kali" >\n' +
                '                                                        </div>\n' +
                '                                                    </div>\n' +
                '                                                    <div class="col-sm-6">\n' +
                '                                                        <div class="form-group">\n' +
                '                                                            <select class="form-control form-control-sm custom-select" name="jenis_programs[]">\n' +
        ...
        function deleteKonten(id) {
            $("#form-deleteKonten-" + id).attr("action", "{{route('h-konten', ["id" => ""])}}/" + id).submit()
        }
    </script>
@endsection
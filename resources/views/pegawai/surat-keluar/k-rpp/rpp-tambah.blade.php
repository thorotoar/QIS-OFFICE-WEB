...
@section('title', 'QIS OFFICE | TAMBAH SURAT PENYUSUN RPP')
    ...
    <div class="page-wrapper">
        ...
        <div class="row page-titles">
            ...
            <div class="col-md-7 align-self-center">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="javascript:void(0)">Tambah Surat Penyusun RPP</a></li>
                    <li class="breadcrumb-item active">Surat Penyusun RPP</li>
                </ol>
            </div>
        </div>
        <!-- End Bread crumb -->
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="basic-elements">
                                <form id="form-addSuratKeluar" action="{{route('surpp-tambah-selesai', ['id' => $jenis->id])}}" enctype="multipart/form-data" method="post">
                                    {{csrf_field()}}
                                    <div class="row">
                                        <div class="col-md-6">

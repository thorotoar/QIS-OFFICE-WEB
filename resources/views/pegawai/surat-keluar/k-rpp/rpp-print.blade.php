...
<head>
    ...
    <title>Surat Keputusan Penyusun Sylabus RPP</title>
    <style type="text/css">
        body, html {
            height: 100%;
            margin: 0;
...
<div>
    ...
    <table width="84%" style="margin-top: 20px" class="text margin-left margin-right">
        <tr>
            <td class="clean" align="justify">Berdasarkan rapat yang dilaksanakan bersama Direktur Quali International pada hari Senin, tanggal 2 Januari 2014,
            </td>
        </tr>
        <tr><td></td></tr>
        <tr><td></td></tr>
    ...
    <table width="84%" style="margin-top: 15px" class="text margin-left margin-right">
        ...
        <tr>
            <td class="clean" align="justify">Nama tersebut di atas di angkat sebagai Penyusun Silabus Pengajaran Bahasa Inggris level elementary , intermediate dan advance di Quali International Surabaya dengan kurun waktu 1 (tahun) terhitung per tanggal 02 Januari 2014 sampai dengan 31 Desember 2014.</td>
        </tr>
        <tr><td></td></tr>
        <tr><td></td></tr>
        <tr><td></td></tr>

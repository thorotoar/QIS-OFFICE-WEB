...
@section('title', 'QIS OFFICE | SURAT PENGANGKATAN')
    ...
    <div class="page-wrapper">
        ...
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <h3 class="text-primary">Surat Pengangkatan</h3> </div>
        ...
        <!-- Start Page Content -->
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Daftar Surat Pengangkatan</h4><hr>
                            <a href="" class="button"></a>
                            <div class="button-list">
                                <a class="btn btn-primary btn-flat" href="{{route('surpengang-tambah')}}">
                                    <i class="fa fa-plus"></i>&nbsp;Tambah Surat</a>
                                <a class="btn btn-primary btn-flat" href="{{route('surpengang-print-all')}}">
    ...
    <script>
        ...
        body.on('click','.sweet-suratMasuk-edit',function () {
            ...
            swal({
                ...
                if (isConfirm){
                    window.location='{{route('surpengang-edit')}}'+'?id='+id;
                }
            })
        });
        ...
        body.on('click','.print',function () {
            id=$(this).data('id');
            window.location='{{route('surpengang-print')}}'+'?id='+id;
        });
        ...
        function deleteDataPegawai(id) {
            swal({
                ...
                $("#form-deleteSuratP-" + id).attr("action", "{{route('surpengang-hapus', ["id" => ""])}}/" + id).submit()
            })
        }

...
@section('title', 'QIS OFFICE | SURAT PENYUSUN SYLABUS')
    ...
    <div class="page-wrapper">
        ...
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <h3 class="text-primary">Surat Penyusun Sylabus</h3> </div>
            <div class="col-md-7 align-self-center">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                    <li class="breadcrumb-item active">Surat Penyusun Sylabus</li>
                </ol>
            </div>
        </div>
        <!-- End Bread crumb -->
        ...
        <!-- Start Page Content -->
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Daftar Surat Penyusun Sylabus</h4><hr>
                            <a href="" class="button"></a>
                            <div class="button-list">
                                <a class="btn btn-primary btn-flat" href="{{route('sursy-tambah')}}">
                                    <i class="fa fa-plus"></i>&nbsp;Tambah Surat</a>
                                <a class="btn btn-primary btn-flat" href="{{route('sursy-print-all')}}">
    ...
    <script>
        ...
        body.on('click','.sweet-suratMasuk-edit',function () {
            ...
            swal({
                ...
                if (isConfirm){
                    window.location='{{route('sursy-edit')}}'+'?id='+id;
                }
            })
        });
        ...
        body.on('click','.print',function () {
            id=$(this).data('id');
            window.location='{{route('sursy-print')}}'+'?id='+id;
        });
        ...
        function deleteDataPegawai(id) {
            swal({
                ...
                $("#form-deleteSuratP-" + id).attr("action", "{{route('sursy-hapus', ["id" => ""])}}/" + id).submit()
            })
        }

                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="form-validation">
                                <form id="form-confirm" class="form-valide" action="{{route('jm-update',['id'=>$jabatan->id])}}" method="post">
                                    {{csrf_field()}}
                                    {{--{{method_field('PUT')}}--}}
                                    <div class="form-group row">
                                        <label class="col-lg-4 col-form-label" for="jabatan">Nama Jabatan </label>
                                        <div class="col-lg-6">
                                            <input type="text" class="form-control" id="jabatan" name="jabatan" placeholder="Masukkan jabatan.." value="{{$jabatan->nama_jabatan}}" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">

!function ($, window, document) {
    ...
    }, today = new Date, pluginName = "wickedpicker", defaults = {
    ...
    $.extend(Wickedpicker.prototype, {
        showPicker: function (e) {
            ...
            if ($(e).attr({
                ...
                var i = this.getText(e), s = /\s[ap]m$/i, o = s.test(i) ? i.substr(-2, 2) : null,
                    n = i.replace(s, "").split(this.options.timeSeparator), r = {};
            ...
            var i = function (e) {
                if ($(t.timepicker).is(":visible")) {
                    if ($(e.target).is(t.close)) t.hideTimepicker(window.lastTimePickerControl); else if ($(e.target).closest(t.timepicker).length || $(e.target).closest($(".hasWickedpicker")).length) e.stopPropagation(); else {
            ...
            var t = new Date;
            t.setMinutes(e);
            var i = t.getMinutes(), s = this.parseSecMin(i);
            ...
            var t = new Date;
            t.setSeconds(e);
            var i = t.getSeconds(), s = this.parseSecMin(i);

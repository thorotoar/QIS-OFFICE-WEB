...
class SuratPengajuanController extends Controller
{
    ...
    public function index(){
        ...
        return view('pegawai.surat-keluar.k-pengajuan.pengajuan-home', compact('smasukView', 'jenisSurat'));
    }
    ...
    public function create(){
        ...
        return view('pegawai.surat-keluar.k-pengajuan.pengajuan-tambah', compact('peserta', 'value', 'kodeSurat'));
    }
    ...
    public function store(Request $request){
        ...
        return redirect()->route('surpenga-home')->with('sukses','Data surat keluar berhasil ditambahkan.');
    }
    ...
    public function edit(Request $request){
        ...
        return view('pegawai.surat-keluar.k-pengajuan.pengajuan-edit', compact('suratM'));
    }
    ...
    public function update(Request $request, $id){
        ...
        return redirect()->route('surpenga-home')->with('edit', 'Data surat masuk berhasil diubah.'); //Lanjutkan dengan mengisi riwayat pendidikan.
    }
    ...
    public function destroy($id){
        ...
        return redirect()->route('surpenga-home')->with('hapus', 'Data terpilih berhasil dihapus.');
    }
    ...
    public function print(Request $request){
        ...
        $pdf->loadView("pegawai.surat-keluar.k-pengajuan.pengajuan-print", compact('data'));
        $pdf->setPaper('A4', 'portrait');
        return $pdf->stream('surat_pengajuan_dana_'.$no.'.pdf');

//        return view('pegawai.surat-keluar.k-pengajuan.pengajuan-print');

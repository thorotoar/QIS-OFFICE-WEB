...
class SuratPenagihanController extends Controller
{
    ...
    public function index(){
        ...
        return view('pegawai.surat-keluar.k-penagihan.penagihan-home', compact('smasukView', 'jenisSurat'));
    }
    ...
    public function create(){
        ...
        return view('pegawai.surat-keluar.k-penagihan.penagihan-tambah', compact('peserta', 'value', 'kodeSurat'));
    }
    ...
    public function store(Request $request){
        ...
        return redirect()->route('surpena-home')->with('sukses','Data surat keluar berhasil ditambahkan.');
    }
    ...
    public function edit(Request $request){
        ...
        return view('pegawai.surat-keluar.k-penagihan.penagihan-edit', compact('suratM'));
    }
    ...
    public function update(Request $request, $id){
        ...
        return redirect()->route('surpena-home')->with('edit', 'Data surat masuk berhasil diubah.'); //Lanjutkan dengan mengisi riwayat pendidikan.
    }
    ...
    public function destroy($id){
        ...
        return redirect()->route('surpena-home')->with('hapus', 'Data terpilih berhasil dihapus.');
    }
    ...
    public function print(Request $request){
        ...
        $pdf->loadView("pegawai.surat-keluar.k-penagihan.penagihan-print", compact('data'));
        $pdf->setPaper('A4', 'portrait');
        return $pdf->stream('surat_penagihan_'.$no.'.pdf');

//        return view('pegawai.surat-keluar.k-penagihan.penagihan-print');

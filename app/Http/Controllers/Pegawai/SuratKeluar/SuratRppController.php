...
class SuratRppController extends Controller
{
    ...
    public function index(){
        ...
        return view('pegawai.surat-keluar.k-rpp.rpp-home', compact('smasukView', 'jenisSurat'));
    }
    ...
    public function create(){
        ...
        return view('pegawai.surat-keluar.k-rpp.rpp-tambah', compact('pegawai', 'value', 'kodeSurat'));
    }
    ...
    public function store(Request $request){
        ...
        return redirect()->route('surpp-home')->with('sukses','Data surat keluar berhasil ditambahkan.');
    }
    ...
    public function edit(Request $request){
        ...
        return view('pegawai.surat-keluar.k-rpp.rpp-edit', compact('suratM'));
    }
    ...
    public function update(Request $request, $id){
        ...
        return redirect()->route('surpp-home')->with('edit', 'Data surat masuk berhasil diubah.'); //Lanjutkan dengan mengisi riwayat pendidikan.
    }
    ...
    public function destroy($id){
        ...
        return redirect()->route('surpp-home')->with('hapus', 'Data terpilih berhasil dihapus.');
    }
    ...
    public function print(Request $request){
        ...
        $pdf->loadView("pegawai.surat-keluar.k-rpp.rpp-print", compact('data'));
        $pdf->setPaper('A4', 'portrait');
        return $pdf->stream('surat_keputusan_penyusun_sylabus_rpp_'.$no);

//        return view('pegawai.surat-keluar.k-rpp.rpp-print');
